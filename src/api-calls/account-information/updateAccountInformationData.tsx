...
export async function updateAccountInformationData(
  id: string,
  auth_id: string,
  token: string,
  pok: string,
  ...
  try {
    const response = await fetch(
      `${dashboard_server}/dashboards/update-set-single-data-objects/${pok}/_id/${id}`,
      {
        method: "PUT",
        mode: "cors",
        headers: {
          ...
          // quickstoredashboard_account_user_id: `${auth_id}`,
