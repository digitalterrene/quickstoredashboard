...
import CategoriesConfiguration from "@/components/ui-components/front-store-configs/categories/CategoriesConfiguration";
import CategoriesPreview from "@/components/ui-components/front-store-configs/categories/CategoriesPreview";
import CategoriesTemplates from "@/components/ui-components/front-store-configs/categories/CategoriesTemplates";
...
export default function StoreCategoriesPage({ response }: { response: any }) {
  const {
    changePreviewDevice,
  ...
  const handleSubmit = async () => {
    ...
    const key_to_update = "categories";
    const value_to_update = frontStoreConfigInputs;
    const id = toast.loading("Updating categories information...");
    ...
    if (res.response === "ok") {
      toast.update(id, {
        render: "Categories updated successfully",
        type: "success",
        isLoading: false,
      });
    } else {
      toast.update(id, {
        render: "Failed to update categories information",
        type: "error",
        isLoading: false,
      });
    }
