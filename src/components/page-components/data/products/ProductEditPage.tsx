...
export default function ProductEditPage({
  ...
  return (
    <div className="px-6 h-full relative py-2">
      <div className="">
      ...
      <div className="flex mt-3 gap-3 h-full relative items-start">
        <div className="sticky w-1/2  ">
          <EditProduct
            predefined_filters={front_store_configuration?.filters}
          />
        </div>
        <div className=" w-1/2 text-center   gap-8 sm:text-left">
          <div className="sm:col-span-8 w-full lg:col-span-7">
            <ul className="  divide-y   border rounded-lg py-2 px-3 text-gray-600 shadow-sm hover:text-gray-700 hover:shadow">
