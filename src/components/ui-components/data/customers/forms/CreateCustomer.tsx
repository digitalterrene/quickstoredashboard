...
const initialInputs: CustomerObjectType = {
  name: "",
  tagline: "",
  phone: "",
  description: "",
...
export default function CreateCustomer() {
  const [inputs, setInputs] = useState<CustomerObjectType>(initialInputs);
  ...
  const handleSubmit = async () => {
    const id = toast.loading("Creating new customer...");
    ...
    if (res.response === "ok") {
      toast.update(id, {
        render: "New customer created successfully",
        type: "success",
        isLoading: false,
      });
    } else {
      toast.update(id, {
        render: "Failed to create new customer",
        type: "error",
        isLoading: false,
      });
    }
              ...
              <div className="sm:col-span-9">
                <div className="flex items-center gap-5">
                  ...
                  <div className="flex gap-x-2">
                    <label htmlFor="uploadFile-CreateCustomer">
                      <input
                        type="file"
                        onChange={async (e) => {
