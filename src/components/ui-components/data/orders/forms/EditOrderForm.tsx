...
export default function EditOrderForm() {
  ...
  const calculateTotal = () => {
    return selectedProducts.reduce((total: number, product: any) => {
  ...
  const handleInputChange = (
    ...
    setUpdatedInputs((prev: any) => {
      const existingIndex = prev.findIndex((input: any) => input.key === name);
      if (existingIndex !== -1) {
  ...
  const handleSubmit = async () => {
    ...
    const data_ = { _id: inputs?._id || "", keys_to_update: updatedInputs };
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16">
          <div>
            <div className="sm:col-span-2 ">
              ...
              <div className="inline-flex items-center py-2 m-auto gap-2    w-full">
                <img
                  className="w-10 h-10 bg-gray-100 border rounded-full "
                  src={
                    sidenavInputs?.customer?.image ||
                    "https://cdn-icons-png.flaticon.com/128/3177/3177440.png"
                  }
                  alt="John"
                />
                <span className="text-gray-600 font-medium flex flex-col truncate max-w-[7.5rem] dark:text-neutral-400">
                  {sidenavInputs?.customer?.name}
                  <span> {sidenavInputs?.customer?.email}</span>
                </span>
              </div>
            </div>
          ...
          <div className="mt-10 lg:mt-0">
            ...
            <div className="col-span-full gap-8 items-center  py-4">
              {selectedProducts?.map(
                ({ name, _id, price, quantity, image }: any) => (
                  <a
                    key={_id}
                  ...
                  >
                    ...
                    <div className="mx-3  flex-col flex">
                      <span className="relative text font-medium  ">
                        {name}
                      </span>
              ...
              <div className="sm:col-span-2">
                <div className="flex items-center gap-5">
                  ...
                  <div className="flex gap-x-2">
                    <label htmlFor="uploadFile-EditOrderForm">
                      <input
                        type="file"
                        onChange={async (e) => {
                ...
                onClick={() => {
                  ...
                  setUpdatedInputs((prev: any) => {
                    ...
                    if (existingIndex !== -1) {
                      ...
                      return [...prev, { key: "products", selectedProducts }];
                    }
                  });
                }}
