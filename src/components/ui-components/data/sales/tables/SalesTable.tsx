...
import { SalesObjectType } from "@/ts-types/data";
...
export default function SalesTable({ sales }: { sales: SalesObjectType[] }) {
  ...
  const [filterBy, setFilterBy] = useState<"name" | "price" | "sale_date">(
    "name"
  );
  ...
  const handleDelete = async () => {
    ...
    const id = toast.loading("Deleting selected sales...");
    let res;
  ...
  const handleChangeordersPerPage = (
    ...
    setCurrentPage(1); // Reset to first page whenever the sales per page changes
  };
  ...
  const handleFilterChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
    setFilterBy(event.target.value as "name" | "price" | "sale_date");
    setCurrentPage(1);
  };
                      ...
                      <div className="inline-flex rounded-lg shadow-sm">
                        ...
                        <div className=" w-32 space-y-3">
                          ...
                          >
                            ...
                            <option value="sale_date">Created At</option>
                          </select>
                        </div>
                      </div>
