...
export default function BillingCard({
  ...
  return (
    <div className="relative m-auto h-64   rounded-xl bg-gradient-to-r from-purple-500 to-blue-600 text-white shadow-2xl transition-transform     ">
      <div className="absolute top-4 w-full px-8 sm:top-8">
        <div className="flex justify-between">
          <div className="">
            <p className="font-light">Name</p>
            <p className="font-medium   tracking-widest">
              {billing_information?.name_on_card || "Full Name"}
            </p>
          </div>
          <img
        ...
        <div className="pt-1">
          ...
          <p className="tracking-more-wider font-medium">
            {billing_information?.card_number || "Card Number"}
          </p>
        </div>
        <div className="pt-4 pr-6 sm:pt-6">
          <div className="flex justify-between">
            <div className="">
              ...
              <p className="text-base font-medium tracking-widest">Date</p>
            </div>
            <div className="">
              <p className="text-xs font-light">Expiry</p>
              <p className="text-base font-medium tracking-widest">
                {billing_information?.expiration_date || "Date"}
              </p>
            </div>
            ...
            <div className="">
              ...
              <p className="tracking-more-wider text-sm font-bold">
                {billing_information?.cvv_code || "CVV Code"}
              </p>
            </div>
          </div>
        </div>
