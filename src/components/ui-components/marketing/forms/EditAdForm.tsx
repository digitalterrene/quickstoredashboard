...
import { AccountInformationMarketingAdObject } from "@/ts-types/account-information";
...
const EditAdForm: React.FC = () => {
  ...
  >([]);
  const keysToUpdate: {
    key: keyof AccountInformationMarketingAdObject;
    value: any;
  }[] = [];
  ...
  const handleSubmit = async () => {
    ...
    updatedKeys.forEach((key) => {
      ...
      const typedKey = key as keyof AccountInformationMarketingAdObject;
        ...
        <div className="mt-4 ">
          <div className="flex items-center gap-5">
            ...
            <div className="flex gap-x-2">
              <label htmlFor="uploadFile-EditAdForm">
                <input
                  type="file"
                  onChange={async (e) => {
