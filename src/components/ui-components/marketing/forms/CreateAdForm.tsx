...
const CreateAdForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    const id = toast.loading("Creating a new ad...");
    ...
    if (res.response === "ok") {
      toast.update(id, {
        render: "New ad created successfully",
        type: "success",
        isLoading: false,
      });
    } else {
      toast.update(id, {
        render: "Failed to create a new ad",
        type: "error",
        isLoading: false,
      });
    }
        ...
        <div className="mt-4 ">
          <div className="flex items-center gap-5">
            ...
            <div className="flex gap-x-2">
              <label htmlFor="uploadFile-CreateAdForm">
                <input
                  type="file"
                  onChange={async (e) => {
