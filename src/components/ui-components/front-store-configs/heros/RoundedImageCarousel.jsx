...
export default function RoundedImageCarousel() {
  useEffect(() => {
    import("preline");
  }, []);
  return (
          ...
          <div className="hs-carousel relative overflow-hidden w-full h-[30rem] md:h-[calc(100vh-106px)]  bg-gray-100 rounded-2xl dark:bg-neutral-800">
            <div className="hs-carousel-body absolute top-0 bottom-0 start-0 flex flex-nowrap transition-transform duration-700 opacity-0">
              <div className="hs-carousel-slide">
                <div
                  style={{
                    backgroundImage: `url('https://img.freepik.com/free-photo/exterior-shopfront-city_53876-144723.jpg?t=st=1716041508~exp=1716045108~hmac=7a450b03f8c4d6ce22ec8ba24541194f5390a6364d0570765eba33a3f3ad0063&w=900')`,
                  }}
                  className="h-[30rem] md:h-[calc(100vh-106px)]  flex flex-col   bg-cover bg-center bg-no-repeat"
                >
                  <div className="mt-auto w-2/3 md:max-w-lg ps-5 pb-5 md:ps-10 md:pb-10">
                    <span className="block text-black">Nike React</span>
              ...
              <div className="hs-carousel-slide">
                <div
                  style={{
                    backgroundImage: `url('https://images.unsplash.com/photo-1612287230202-1ff1d85d1bdf?q=80&w=3542&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')`,
                  }}
                  className="h-[30rem] md:h-[calc(100vh-106px)]  flex flex-col   bg-cover bg-center bg-no-repeat"
                >
                  <div className="mt-auto w-2/3 md:max-w-lg ps-5 pb-5 md:ps-10 md:pb-10">
                    <span className="block text-black">CoolApps</span>
                    <span className="block text-black text-xl md:text-3xl">
              ...
              <div className="hs-carousel-slide">
                ...
                >
                  <div className="mt-auto w-2/3 md:max-w-lg ps-5 pb-5 md:ps-10 md:pb-10">
                    <span className="block text-black">Grumpy</span>
                    <span className="block text-black text-xl md:text-3xl">
