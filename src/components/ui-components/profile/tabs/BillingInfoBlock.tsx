...
export default function BillingInfoBlock({
  ...
  return (
    <div className="w-full">
      <div className="relative m-auto h-fit min-w-52 rounded-xl bg-gradient-to-r from-gray-500 to-gray-400 text-white transition-transform min-h-56  ">
        <div className="absolute top-4 w-full px-8 sm:top-8">
          <div className="flex justify-between">
            <div className="">
              <p className="font-light">Name</p>
              <p className="font-medium tracking-widest">
                {billing_information?.name_on_card}
              </p>
            </div>
            <img
            ...
            <div className="flex justify-between">
              <div className="">
                ...
                <p className="text-base font-medium tracking-widest">
                  {billing_information?.expiration_date}
                </p>
              </div>
